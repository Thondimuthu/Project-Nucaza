...
export function StickersIcon() {
    return (
        <>
            <svg className='size-6' stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20m0-20a10 10 0 1 0 0 20 10 10 0 0 0 0-20"></path></svg>
        </>
    )
}
